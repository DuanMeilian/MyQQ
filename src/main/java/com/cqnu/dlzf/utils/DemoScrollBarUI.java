...
/**
 * 自定义滚动条UI
 * 转载自博客园 https://www.cnblogs.com/LiuYanYGZ/p/9490880.html
 * @author LiuYanYGZ
 */
public class DemoScrollBarUI extends BasicScrollBarUI {
    ...
    protected void paintThumb(Graphics g, JComponent c, Rectangle thumbBounds) {
        ...
        // 设置填充颜色，这里设置了渐变，由下往上
        Color color = new Color(177,179,181);

        g2.setPaint(new GradientPaint(c.getWidth() / 2, 1, color,

                c.getWidth() / 2, c.getHeight(), color));
